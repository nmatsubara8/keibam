...
TRAINING_FIELDS: tuple[FieldSpec, ...] = (
    ...
    FieldSpec("調教ラップ", SRC_TRAINING, acquired=False, note="6F〜1F の分解"),
    FieldSpec("終い", SRC_TRAINING, acquired=False, note="ラスト1F。→ コース別標準化"),
    FieldSpec("位置", SRC_TRAINING, acquired=False, note="併走時の追走位置"),
    FieldSpec("脚色", SRC_TRAINING, acquired=False, note="馬也/一杯/強め"),
    FieldSpec("調教評価", SRC_TRAINING, acquired=False, note="叩き良化 等テキスト"),
    FieldSpec("映像グレード", SRC_TRAINING, acquired=False, note="A/B/C。順序特徴"),
