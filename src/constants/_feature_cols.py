...
# 馬主/生産者は母数が騎手より小さいため直近 N を大きめに取る
OWNER_RECENT_N: int = 100

OWNER_BREEDER_FEATURE_COLS: list = [
    "owner_win_rate",     # 馬主の直近勝率
    "owner_avg_rank",     # 馬主の直近平均着順(相対)
    "breeder_win_rate",   # 生産者の直近勝率
    "breeder_avg_rank",   # 生産者の直近平均着順(相対)
]
