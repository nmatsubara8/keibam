...
# 横断インフラ（DB 優先読込・ジョブ計測/記録/通知）は _cli_common に分離。各ハンドラは
# 素の名前で参照し、テストの monkeypatch.setattr(run_pipeline, ...) も従来通り効く（再 export）。
from src.pipeline._cli_common import (  # noqa: E402
    _auto_migrate_db,
    _load_raw_db_first,
